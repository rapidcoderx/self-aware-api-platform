        ...
        <div className="flex gap-2">
          ...
          {messages.length > 0 && (
            <button
              ...
              disabled={loading}
              title="Clear chat"
              className="rounded-lg border border-gray-700 bg-gray-800 px-3 py-2.5 text-sm font-medium text-gray-400 hover:bg-gray-700 hover:text-gray-200 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
